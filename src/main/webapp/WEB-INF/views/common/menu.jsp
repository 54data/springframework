    ...
    <div id="ch10" class="accordion-collapse collapse ${chNum=='ch10'?'show':''}" data-bs-parent="#accordionMenu">
      <div class="accordion-body">
      	<ul>
        	...
        	<li><a href="${pageContext.request.contextPath}/ch10/404404404404404404404">404 처리</a></li>
      	</ul>
      </div>
    </div>
  </div>
    ...
    <div id="ch14" class="accordion-collapse collapse ${chNum=='ch14'?'show':''}" data-bs-parent="#accordionMenu">
      <div class="accordion-body">
      	<ul>
        	...
        	<li><a href="${pageContext.request.contextPath}/ch14/afterReturning">메소드 정상적으로 리턴값을 제공할 경우 공통 코드 실행</a></li>      	
        	...
        	<li><a href="${pageContext.request.contextPath}/ch14/boardList">AOP 사례 : 실행 시간 측정</a></li>      	
        	<li><a href="${pageContext.request.contextPath}/ch14/writeBoardForm">AOP 사례 : 로그인 체크</a></li>      	
      	</ul>
      </div>
    </div>
  </div>
    ...
    <div id="ch17" class="accordion-collapse collapse ${chNum=='ch17'?'show':''}" data-bs-parent="#accordionMenu">
      <div class="accordion-body">
      	<ul>
        	...
        	<li>
        		<a href="${pageContext.request.contextPath}/ch17/userInfo">로그인한 사용자 정보보기</a>
        	</li>
      	</ul>
      </div>
    </div>
